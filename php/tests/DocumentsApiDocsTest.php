 ...
 */
final class DocumentsApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new DocumentsModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new DocumentsModule())->permissions(),
        );

        foreach ((new DocumentsModule())->apiDocs() as $doc) {
